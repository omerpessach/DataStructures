#ifndef INCLUDE_CONTAINERS_LINKEDLIST_LINKEDLISTARRAY__H
#define INCLUDE_CONTAINERS_LINKEDLIST_LINKEDLISTARRAY__H
...
#endif // !INCLUDE_CONTAINERS_LINKEDLIST_LINKEDLISTARRAY__H
